    ...
    <div class="relative">
      <DatePicker v-model="date" color="blue">
        <template v-slot="{ inputValue, togglePopover }">
          ...
          <div @click="togglePopover" class="bg-primary hover:opacity-80 transition duration-150 cursor-pointer rounded-full inline-block top-0 right-0 absolute laptop:p-2 desktop:p-3">
