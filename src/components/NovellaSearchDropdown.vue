...
export interface NovellaSearchDropdownField {
  id: string | number;
  title: string;
  subtitle: string;
}

interface NovellaSearchDropdownProps {
  searchData: NovellaSearchDropdownField[];
}

defineProps<NovellaSearchDropdownProps>();
</script>
